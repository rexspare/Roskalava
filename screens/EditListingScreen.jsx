...
var map = L.map('map', {
  zoom: 10,
  maxZoom: 18,
  center: [${region.latitude || config?.map?.center?.lat || 0}, ${region.longitude || config?.map?.center?.lng || 0
    }],
  layers: [osmLayer],
});
const marker = L.marker([${markerPosition.latitude || config?.map?.center?.lat || 0
                      ...
                      <View>
                        ...
                        <View style={{ paddingHorizontal: "3%" }}>
                          <AppButton
                            ...
                            //   console.log({
                            //     Obj : errors,
                            //     custom : customErrorFields,
                            //     common : commonErrorFields
                            //   });
                            //   console.log('====================================');
                            // }}
