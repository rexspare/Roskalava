  ...
  const [validationSchema, setValidationSchema] = useState(
    Yup.object().shape({
      first_name: Yup.string().required(
        __("editPersonalDetailScreenTexts.fieldLabels.firstName", appSettings.lng) +
          " " +
          __(
      ...
      last_name: Yup.string().required(
        __("editPersonalDetailScreenTexts.fieldLabels.lastName", appSettings.lng) +
          " " +
          __(
            "editPersonalDetailScreenTexts.formValidation.requiredField",
            appSettings.lng
      ...
      address: Yup.string().min(
        1, // Change the minimum length to 1 or remove it entirely to make it not required
        __(
